...
public class PartTimeAndWage {
	...
	public static void main(String[] args) {
		...
		/*
		 * Using Random function taking input either 0 or 1 or 2. 
		 * 0 = Employee absent ,1 = full time and 0 = Part time .
		 * calculating wage accordingly
		 */
